...
public class AssignHbefaRoadTypes {
    ...
    static String inputFile = "Z:/projects/2019/BASt/data/input_files_matsim/final_network.xml.gz";
    static String outputFile ="Z:/projects/2019/BASt/data/input_files_matsim/emissions_noise/final_network_emissions.xml.gz";
    ...
    public static void main(String args[]) {
        ...
        processLinksGermanyWide(inputFile, outputFile);


    }


    private static void processLinksGermanyWide(String inputFile, String outputFile) {
